...
runnumberalignmentIOV = 251510          #any run number in the iov that you want to start from
...
outputfilename = 'dbfiles/trytofix/IOV/hp1519_run251510_modulatedLayerRot_TEC-only_epsilon%s_delta%s.db' % (modulatedLayerRotEpsilon, modulatedLayerRotDelta)
